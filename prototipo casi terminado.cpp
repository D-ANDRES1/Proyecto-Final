...
void AsignarCursos() {
    ...
    cout << "Ingrese el codigo del curso (número):" << endl;
    ...
    if (asigcurso.cursosAsignados >= LIMITE_CURSOS) {
        cout << "Limite de cursos alcanzado. No se pueden asignar más cursos.\n";
        return;
    }
...
void mostrarDyM(Estudiante &nuevoEstudiante) {
    ...
    while (true) {
        ...
        if (dptoIndice > 0 && dptoIndice <= departamentos.size()) {
            ...
            cout << "Indice de departamento no válido.\n";
        }
    }
}
...
void reporteEstudiante() {
    ...
    for (const auto& estudiante : estudiantes) {
        ...
        cout << "Teléfono personal: " << estudiante.telefonope << endl;
        cout << "Teléfono de casa: " << estudiante.telefonoca << endl;
        cout << "Teléfono de emergencia: " << estudiante.telefonoem << endl;
    }
}
...
void reporteNotas() {
    ...
    for (const auto& nota : notas) {
        cout << "Código Estudiante: " << nota.codigoEstudiante << endl;
        cout << "Código Curso: " << nota.codigoCurso << endl;
